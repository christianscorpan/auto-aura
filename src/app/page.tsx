      ...
      <section className="scroll-snap-section w-full h-screen flex flex-col justify-between bg-gradient-to-br from-black via-gray-900 to-black text-white">
        <div className="absolute inset-0 overflow-hidden">
             <Image
                ...
                alt="Mercedes AMG"
                fill
                className="object-cover opacity-50 [filter:drop-shadow(0_0_10px_rgba(255,255,255,0.2))] scale-110 translate-x-[2rem] md:scale-125 md:translate-x-[15rem] md:translate-y-20"
                priority
